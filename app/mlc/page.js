            ...
            return (
              ...
              >
                ...
                <div className="text-left md:text-center mt-2">
                  ...
                  <div className="text-sky-200 group-hover:text-white block">
                    {el.role}
                  </div>
                  {el.subtitle && (
                    <div className="text-sky-200 text-xs font-bold">
                      {el.subtitle}
                    </div>
                  )}
                </div>
      ...
      <div className="my-5 grid w-full gap-7 max-w-5xl">
        ...
        <div>
          ...
          <p className="block md:text-xl indent-5">
            ...
            <b className="text-sky-200">30 คน จาก 5 เครือข่ายทางสังคม</b>{" "}
