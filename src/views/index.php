      ...
      ?>
        <a <?php if (!isset($speaker["history"])) {
          ...
          <div class="text-left md:text-center mt-2">
            <div class="text-sky-200 group-hover:text-white text-lg font-bold mb-0 pb-0 break-words">
              <?= $speaker["name"] ?>
            </div>
            <div class="text-sky-200 group-hover:text-white block">
              <?= $speaker["role"] ?>
            </div>
            <?php if (isset($speaker["subtitle"])) { ?>
              <div class="text-sky-200 text-xs font-bold">
                <?= $speaker["subtitle"] ?>
              </div>
            <?php } ?>
          </div>
